                                            ...
                                            <div class="text-center p-sm-4 pt-4 mt-2">
                                                <div class="avatar-md mx-auto border border-soft-primary p-1 rounded-circle mb-2" style="height: 6rem;width: 6rem;">
                                                    ...
                                                    <span class="avatar-title rounded-circle bg-soft-primary text-primary h3">
                                                        ...
                                                        <img class="rounded-circle" width="85" height="85" src="img/E.png">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="mb-sm-0 mb-3">
                                                                <p class="text-muted mb-2 text-truncate">
                                                                    <i class="uil uil-import mr-1"></i> Abrir a 1º vez com internet!
                                                                </p>
                                                                <h5 class="mb-0">
                                            ...
                                            <div class="text-center p-sm-4 pt-4 mt-2">
                                                <div class="avatar-md mx-auto border border-soft-primary p-1 rounded-circle mb-2" style="height: 6rem;width: 6rem;">
                                                    ...
                                                    <span class="avatar-title rounded-circle bg-soft-primary text-primary h3">
                                                        ...
                                                        <img class="rounded-circle" width="85" height="85" src="img/plus.png">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="text-sm-right d-none d-sm-block">
                                Desenvolvido por <a href="https://t.me/nandoslayer" target="_blank" class="text-reset font-weight-bold">GESTOR-SSH</a>
