...
<html lang="pt-br">
    ...
    <body style="
        ...
        <img src="./img/giphy.gif" style="height:140px;">
            ...
            <p class="copyright">&copy; 2021 - <script> document.write(new Date().getFullYear())</script><br> Todos os direitos reservados<br><a title="Styleshout" href="https://t.me/nandoslayer">GESTOR-SSH</a></p>
    </body>
</html>
