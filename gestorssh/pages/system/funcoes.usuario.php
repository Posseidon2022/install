    ...
    if ($operacao == "new") {
        if ((isset($_GET["diretorio"])) &&
            ...
            if (($SQLUsuario->rowCount()) > 0) {
                echo myalertuser('warning', 'O usuario ' . $_GET['login'] . ' ja existe!', $diretorio);
                exit;
            }
            ...
            if ($tipouser == 'erro') {
                echo myalertuser('warning', 'Selecione o tipo de usuario', $diretorio);
                exit;
            }
            if ($tipouser == 'revenda') {
                $subrevenda = 'sim';
                if ($eumesmo['subrevenda'] == 'sim') {
                    echo myalertuser('warning', 'No momento vc nao pode adicionar revenda!', $diretorio);
                    exit;
                }
            } else {
                $subrevenda = 'nao';
        ...
        $SQLSMS->execute();
            */
            ...
            echo myalertuser('success', 'Conta adicionada com sucesso !', $diretorio);
            exit;
        } else {
