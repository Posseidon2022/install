                            ...
                            <li class="list-group-item">
                                ...
                                <li class="list-group-item">
                                    <div class="transaction-item">
                                        ...
                                        <div class="fw-bolder text-warning"><?php echo $usuario_sistema['nome']; ?></div>
                                    </div>
                                </li>
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group mb-1">
                                                ...
                                                <?php } else { ?>
                                                    <button ype="submit" data-toggle="tooltip" title="Suspende Temporariamente" class="btn btn-warning" id="op" name="op" value="suspender">Suspender conta</button>
                                                <?php } ?>
                                            </li>
                                        </ul>
                    ...
                    <div class="card border-primary">
                        <div class="card-body p-b-0">
                            ...
                            <?php if ($usuario['subrevenda'] <> 'sim') { ?>
                                    <li class="nav-item"> <a class="nav-link active" ddata-bs-toggle="tab" href="#dono" role="tab"><span class="hidden-sm-up"><i data-feather="users"></i></span> <span class="hidden-xs-down">Alterar Dono</span></a> </li>
                                <?php } ?>
                                ...
                                <div class="active tab-pane" id="dono">
                                    <?php if ($usuario['tipo'] == "revenda") { ?>
                                        ...
                                        <div class="box box-primary">
                                            <center>
                                                <h3 class="box-title">Dono da conta SSH </h3>
                                            </center>
                                        </div>
                                        <!-- /.box-header -->
                                        <!-- form start -->
                                ...
                                <div class="tab-pane" id="vencimento">
                                    <?php if ($usuario['tipo'] == "revenda") { ?>
                                        <div class="box box-primary">
                                            <div class="box-header with-border">
                                                <center>
                                                    <h3 class="box-title">Dias de acessos </h3>
                                                </center>
                                            </div>
                                            <!-- /.box-header -->
                                            <!-- form start -->
                                ...
                                <div class="tab-pane" id="acesso">
                                    <?php if ($usuario['tipo'] == "revenda") { ?>
                                        ...
                                        <div class="box box-primary">
                                            <div class="box-header with-border">
                                                <center>
                                                    <h3 class="box-title">Acesso simultâneo </h3>
                                                </center>
                                            </div>
                                            <!-- /.box-header -->
                                            <!-- form start -->
