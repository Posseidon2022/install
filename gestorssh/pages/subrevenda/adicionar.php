                                    ...
                                    <div class="demo-spacing-0 mb-3">
                                        <div class="alert alert-warning" role="alert">
                                            <div class="alert-body d-flex align-items-center">
                                                ...
                                                <span> Logo abaixo Você entrega parte de seu limite em um dos seus servidores ao seu Subrevendedor não é possivel entregar mais que o seu limite disponivel. !</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
