...
if((isset($_POST["login"])) and (isset($_POST["nome"])) and (isset($_POST["senha"]))  and (isset($_POST["tipo"]))  and (isset($_POST["celular"])) ){
	...
	if(($SQLUsuario->rowCount()) > 0){
		echo alertinfo('error', 'O usuario '.$_POST['login'].' ja existe', '../../home.php?page=usuario/1-etapa');
	}else{	
		...
		echo alertinfo('success', 'O usuario '.$_POST['login'].' foi criado com sucesso!', '../../home.php?page=usuario/perfil&id_usuario='.$id['last_id'] .' ');
	}
